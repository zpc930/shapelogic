 ...
 *
 */
public class BaseListStream1Test extends TestCase {
	BaseListStream1<Integer,Integer> evenNumbers;
	
	@Override
	public void setUp() {
		NaturalNumberStream naturalNumbers = new NaturalNumberStream();
		evenNumbers = new BaseListStream1<Integer,Integer>(naturalNumbers,2){
