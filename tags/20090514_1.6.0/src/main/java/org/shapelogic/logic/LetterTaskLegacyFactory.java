...
public class LetterTaskLegacyFactory {
	...
	static public BaseTask createLetterATask(BaseTask parentTask) {
		...
		SimpleNumericTask horizontalLineCountTask = new SimpleNumericTask(letterATask, false,polygonDot+HORIZONTAL_LINE_COUNT_EX+dotSize,1);
		horizontalLineCountTask.setName(HORIZONTAL_LINE_COUNT);
		SimpleNumericTask verticalLineCountTask = new SimpleNumericTask(letterATask, false,polygonDot+VERTICAL_LINE_COUNT_EX+dotSize,0);
	...
	static public NumericRule[] getSimpleNumericRuleForAllStraightLetters(String polygon) {
		NumericRule[] numericRulesForAll = {
			...
			new NumericRule("A", LINE_COUNT, polygon, LINE_COUNT_EX, 5.,COUNT_COLLECTION_TASK),
			new NumericRule("A", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("A", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("E", LINE_COUNT, polygon, LINE_COUNT_EX, 5.,COUNT_COLLECTION_TASK),
			new NumericRule("E", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 3.,COUNT_COLLECTION_TASK),
			new NumericRule("E", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("F", LINE_COUNT, polygon, LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("F", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("F", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("H", LINE_COUNT, polygon, LINE_COUNT_EX, 5.,COUNT_COLLECTION_TASK),
			new NumericRule("H", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("H", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("I", LINE_COUNT, polygon, LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("I", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("I", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("K", LINE_COUNT, polygon, LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("K", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("K", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("L", LINE_COUNT, polygon, LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("L", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("L", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("L", HARD_POINT_COUNT, polygon, HARD_POINT_COUNT_EX, 1.,"SimpleNumericTask"),
			...
			new NumericRule("M", LINE_COUNT, polygon, LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("M", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("M", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("N", LINE_COUNT, polygon, LINE_COUNT_EX, 3.,COUNT_COLLECTION_TASK),
			new NumericRule("N", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("N", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("T", LINE_COUNT, polygon, LINE_COUNT_EX, 3.,COUNT_COLLECTION_TASK),
			new NumericRule("T", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("T", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("V", LINE_COUNT, polygon, LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("V", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("V", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("W", LINE_COUNT, polygon, LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("W", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("W", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("X", LINE_COUNT, polygon, LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("X", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("X", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("Y", LINE_COUNT, polygon, LINE_COUNT_EX, 3.,COUNT_COLLECTION_TASK),
			new NumericRule("Y", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("Y", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("Z", LINE_COUNT, polygon, LINE_COUNT_EX, 3.,COUNT_COLLECTION_TASK),
			new NumericRule("Z", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("Z", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
	 ...
	 * <p/>
	 * This version is left in as an example of the old syntax, but this have 
	 * been superseded by the new uniform syntax that is creating ParametricRuleTask.
	 * 
	 * @param polygon is a String that contain the context variable that the rules will be applied to
	 */
	@Deprecated
	static public NumericRule[] getSimpleNumericRuleForAllLettersNonParametric(String polygon) {
		NumericRule[] numericRulesForAll = {
			new NumericRule("A", POINT_COUNT, polygon, POINT_COUNT_EX, 5.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("A", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("A", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 2.,SIMPLE_NUMERIC_TASK),
			new NumericRule("A", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),

			new NumericRule("B", HOLE_COUNT, polygon, HOLE_COUNT_EX, 2.,SIMPLE_NUMERIC_TASK),
			new NumericRule("B", T_JUNCTION_LEFT_POINT_COUNT, polygon, T_JUNCTION_LEFT_POINT_COUNT_EX, 0.,FILTER_COUNT_GREATER_TASK),
			new NumericRule("B", U_JUNCTION_POINT_COUNT, polygon, U_JUNCTION_POINT_COUNT_ANN_EX, 2.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("B", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,SIMPLE_NUMERIC_TASK),
			new NumericRule("B", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("B", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 0.,SIMPLE_NUMERIC_TASK),
			new NumericRule("B", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("C", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("C", CURVE_ARCH_COUNT, polygon, CURVE_ARCH_COUNT_ANN_EX, 1.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("C", HARD_CORNER_COUNT, polygon, HARD_CORNER_COUNT_EX, 0.,FILTER_COUNT_TASK),
			new NumericRule("C", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
...
//			new NumericRule("D", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,SIMPLE_NUMERIC_TASK),
			new NumericRule("D", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("D", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("D", HARD_CORNER_COUNT, polygon, HARD_CORNER_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("E", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("E", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("E", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 3.,SIMPLE_NUMERIC_TASK),
			new NumericRule("E", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("E", POINT_COUNT, polygon, POINT_COUNT_EX, 5.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("F", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("F", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 3.,SIMPLE_NUMERIC_TASK),
			new NumericRule("F", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("G", CURVE_ARCH_COUNT, polygon, CURVE_ARCH_COUNT_ANN_EX, 2.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("G", HARD_CORNER_COUNT, polygon, HARD_CORNER_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("G", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("H", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("H", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 4.,SIMPLE_NUMERIC_TASK),
			new NumericRule("H", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("I", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("J", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,SIMPLE_NUMERIC_TASK),
			new NumericRule("J", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("J", CURVE_ARCH_COUNT, polygon, CURVE_ARCH_COUNT_EX2, 0.,NUMERIC_GREATER_TASK),
			new NumericRule("J", HARD_CORNER_COUNT, polygon, HARD_CORNER_COUNT_EX, 0.,FILTER_COUNT_TASK),
			new NumericRule("J", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
...
//			new NumericRule("K", T_JUNCTION_RIGHT_POINT_COUNT, polygon, T_JUNCTION_RIGHT_POINT_COUNT_EX, 0.,"FilterCountTask"),
			...
			new NumericRule("K", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			new NumericRule("K", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 4.,SIMPLE_NUMERIC_TASK),
			new NumericRule("K", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("L", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("M", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("N", MULTI_LINE_COUNT, polygon, MULTI_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("N", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("O", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,SIMPLE_NUMERIC_TASK),
			...
			new NumericRule("O", CURVE_ARCH_COUNT, polygon, CURVE_ARCH_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("O", HARD_CORNER_COUNT, polygon, HARD_CORNER_COUNT_EX, 0.,FILTER_COUNT_TASK),
			new NumericRule("O", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("P", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("P", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 1.,SIMPLE_NUMERIC_TASK),
			new NumericRule("P", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
...
//			new NumericRule("Q", T_JUNCTION_LEFT_POINT_COUNT, polygon, T_JUNCTION_LEFT_POINT_COUNT_EX, 0.,FILTER_COUNT_TASK),
			...
			new NumericRule("Q", CURVE_ARCH_COUNT, polygon, CURVE_ARCH_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
//			new NumericRule("Q", HARD_POINT_COUNT, polygon, HARD_POINT_COUNT_EX, 0.,FILTER_COUNT_TASK),
			new NumericRule("Q", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("R", U_JUNCTION_POINT_COUNT, polygon, U_JUNCTION_POINT_COUNT_ANN_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("R", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("R", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 2.,SIMPLE_NUMERIC_TASK),
			new NumericRule("R", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("S", INFLECTION_POINT_COUNT, polygon, INFLECTION_POINT_COUNT_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			new NumericRule("S", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("T", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("T", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 3.,SIMPLE_NUMERIC_TASK),
			new NumericRule("T", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("U", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("U", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 2.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("U", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_GREATER_TASK),
			...
			new NumericRule("V", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("W", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("X", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 0.,COUNT_COLLECTION_TASK),
			new NumericRule("X", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 4.,SIMPLE_NUMERIC_TASK),
			new NumericRule("X", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
			...
			new NumericRule("Y", VERTICAL_LINE_COUNT, polygon, VERTICAL_LINE_COUNT_EX, 1.,COUNT_COLLECTION_TASK),
			new NumericRule("Y", END_POINT_COUNT, polygon, END_POINT_COUNT_EX, 3.,SIMPLE_NUMERIC_TASK),
			new NumericRule("Y", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
...
//			new NumericRule("Z", END_POINT_TOP_LEFT_THIRD_POINT_COUNT, polygon, END_POINT_TOP_LEFT_THIRD_POINT_COUNT_EX, 1.,FILTER_COUNT_TASK),
			new NumericRule("Z", POINT_COUNT, polygon, POINT_COUNT_EX, 4.,COUNT_COLLECTION_TASK),
			new NumericRule("Z", SOFT_POINT_COUNT, polygon, SOFT_POINT_COUNT_ANN_EX, 0.,COUNT_COLLECTION_TASK),
		};
		return numericRulesForAll;
	}
	...
	static public BaseTask createLetterATaskFromRule(BaseTask parentTask) {
		...
		NumericRule[] numericRulesForA = LetterTaskLegacyFactory.getSimpleNumericRuleForAllStraightLetters(POLYGON);
