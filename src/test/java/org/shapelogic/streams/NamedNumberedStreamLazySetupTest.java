 ...
 *
 */
public class NamedNumberedStreamLazySetupTest extends TestCase {
	...
	public void testNext() {
		NumberedStream<Integer> stream = new NamedNumberedStreamLazySetup<Integer>("naturalNumbersTo3");
