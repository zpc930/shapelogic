...
//			new NumericRule("D", HORIZONTAL_LINE_COUNT, polygon, HORIZONTAL_LINE_COUNT_EX, 1.,SIMPLE_NUMERIC_TASK),
			new NumericRule("D", VERTICAL_LINE_COUNT, polygon, VAR + VERTICAL_LINE_COUNT_EX, ">", 0.),
			...
			new NumericRule("D", SOFT_POINT_COUNT, polygon, VAR + SOFT_POINT_COUNT_EX2, ">", 0.),
			new NumericRule("D", HARD_POINT_COUNT, polygon, VAR + HARD_POINT_COUNT_EX2, ">", 0.),
