...
public class LetterTaskFactory {
	...
	static public NumericRule[] getSimpleNumericRuleForAllLetters(String polygon) {
		...
		if (USE_LEGACY_SYNTAX)
			return LetterTaskLegacyFactory.getSimpleNumericRuleForAllLettersNonParametric(polygon);
...
//			new NumericRule("D", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 1.),
			...
			new NumericRule("D", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
			new NumericRule("D", HARD_POINT_COUNT, polygon, size(HARD_POINT_COUNT_ANN_EX), ">", 0.),
			...
			new NumericRule("E", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), ">", 1.),
			new NumericRule("E", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), ">", 1.),
			new NumericRule("E", END_POINT_COUNT, polygon, VAR + END_POINT_COUNT_EX, "==", 3.),
			new NumericRule("E", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), "==", 0.),
			new NumericRule("E", POINT_COUNT, polygon, size(POINT_COUNT_EX), ">", 5.),
...
//			new NumericRule("F", HARD_POINT_COUNT, polygon, filter(HARD_POINT_COUNT_EX), ">", 0.),
			...
			new NumericRule("G", CURVE_ARCH_COUNT, polygon, size(CURVE_ARCH_COUNT_ANN_EX), ">", 2.),
			...
			new NumericRule("H", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 1.),
			new NumericRule("H", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 4.),
			new NumericRule("H", END_POINT_COUNT, polygon, VAR + END_POINT_COUNT_EX, "==", 4.),
			new NumericRule("H", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), "==", 0.),
			...
			new NumericRule("I", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
			new NumericRule("I", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 1.),
			...
			new NumericRule("I", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), "==", 0.),
...
//			new NumericRule("J", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
			new NumericRule("J", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 1.),
...
//			new NumericRule("J", CURVE_ARCH_COUNT, polygon, VAR + CURVE_ARCH_COUNT_EX2, "==", 0.),
			...
			new NumericRule("J", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
...
//			new NumericRule("K", T_JUNCTION_RIGHT_POINT_COUNT, polygon, filter(T_JUNCTION_RIGHT_POINT_COUNT_EX), "==", 0.),
			...
			new NumericRule("K", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
			...
			new NumericRule("L", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 1.),
			new NumericRule("L", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 1.),
			...
			new NumericRule("M", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
			new NumericRule("M", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 2.),
			...
			new NumericRule("M", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), "==", 0.),
			...
			new NumericRule("N", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
			new NumericRule("N", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 2.),
...
//			new NumericRule("N", MULTI_LINE_COUNT, polygon, size(MULTI_LINE_COUNT_EX), "==", 1.),
			new NumericRule("N", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), "==", 0.),
...
//			new NumericRule("O", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
//			new NumericRule("O", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 1.),
			...
			new NumericRule("O", CURVE_ARCH_COUNT, polygon, size(CURVE_ARCH_COUNT_ANN_EX), ">", 0.),
			new NumericRule("O", HARD_POINT_COUNT, polygon, filter(HARD_POINT_COUNT_EX), "==", 0.),
			new NumericRule("O", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
...
//			new NumericRule("P", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 1.),
			new NumericRule("P", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 2.),
			new NumericRule("P", END_POINT_COUNT, polygon, VAR + END_POINT_COUNT_EX, "==", 1.),
			new NumericRule("P", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
...
//			new NumericRule("Q", T_JUNCTION_LEFT_POINT_COUNT, polygon, VAR + T_JUNCTION_LEFT_POINT_COUNT_EX, "==", 0.),
			...
			new NumericRule("Q", CURVE_ARCH_COUNT, polygon, size(CURVE_ARCH_COUNT_ANN_EX), ">", 0.),
//			new NumericRule("Q", HARD_POINT_COUNT, polygon, filter(HARD_POINT_COUNT_EX), "==", 0.),
			new NumericRule("Q", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
			...
			new NumericRule("R", U_JUNCTION_POINT_COUNT, polygon, size(U_JUNCTION_POINT_COUNT_ANN_EX), "==", 2.),
			...
			new NumericRule("R", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), ">", 0.),
			new NumericRule("R", END_POINT_COUNT, polygon, VAR + END_POINT_COUNT_EX, "==", 2.),
			new NumericRule("R", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
			...
			new NumericRule("S", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
...
//			new NumericRule("T", VERTICAL_LINE_COUNT, polygon, size(VERTICAL_LINE_COUNT_EX), "==", 1.),
			...
			new NumericRule("U", SOFT_POINT_COUNT, polygon, size(SOFT_POINT_COUNT_ANN_EX), ">", 0.),
			...
			new NumericRule("X", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
			...
			new NumericRule("Y", HORIZONTAL_LINE_COUNT, polygon, size(HORIZONTAL_LINE_COUNT_EX), "==", 0.),
