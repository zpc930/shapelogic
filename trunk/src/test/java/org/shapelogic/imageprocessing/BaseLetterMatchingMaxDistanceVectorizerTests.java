 ...
 *
 */
public class BaseLetterMatchingMaxDistanceVectorizerTests extends BaseLetterMatchingForVectorizersTests {
	...
	public void testB() {
		String fileName = "B";
		SLImage bp = runPluginFilterOnBufferedImage(filePath(fileName), vectorizer);
